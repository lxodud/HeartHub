//
//  PersonalInformationCollectionAndUsageDetailViewController.swift
//  HeartHub
//
...
final class PersonalInformationCollectionAndUsageDetailViewController: UIViewController {
    private let termDetailView = TermDetailView(
        termText: """
...
extension PersonalInformationCollectionAndUsageDetailViewController {
    ...
    private func configureLayout() {
        ...
        NSLayoutConstraint.activate([
            termDetailView.topAnchor.constraint(
                equalTo: safeArea.topAnchor
            ),
            termDetailView.leadingAnchor.constraint(
                equalTo: safeArea.leadingAnchor
            ),
            termDetailView.trailingAnchor.constraint(
                equalTo: safeArea.trailingAnchor
            ),
            termDetailView.bottomAnchor.constraint(
